...
public class Main {
    public static void main(String[] args) {
        ...
        manager.createStandartTask(task1);
        Task task2 = new Task("Ретро по спринту", "11:00 Ссылка на зум-встречу");
        manager.createStandartTask(task2);
        ...
        System.out.println("Задачи " + manager.getAllStandartTasks());
        ...
        for (Integer id : epic3.getSubtasks()) {
        ...
        manager.updateStandartTask(task1);
        System.out.println(manager.getStandartTask(task1.getId()));
        ...
        manager.deleteAllStandartTasks();
        System.out.println("Задачи " + manager.getAllStandartTasks());
        System.out.println("Эпики " + manager.getAllEpicTasks());
        System.out.println("Подзадачи " + manager.getAllSubtasks());
